              ...
              <div className="mb-8 md:mb-0">
                ...
                >
                  <div>
                    ...
                    <div className="text-gray-600">Step up your style game with the freshest kicks from WeSupply India – your go-to destination for all things sneaker hypebeast!</div>
                  </div>
