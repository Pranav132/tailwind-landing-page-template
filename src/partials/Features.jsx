              ...
              <div className="mb-8 md:mb-0">
                ...
                >
                  <div>
                    ...
                    <div className="text-gray-600">Built WeSupply's eCommerce Website using <strong>shopify and coding custom solutions in shopify liquid.</strong></div>
                  </div>
                ...
                >
                  <div>
                    ...
                    <div className="text-gray-600">Made an Event Branding Website for a 3v3 Basketball tournament using<strong> ReactJs and Supabase.</strong></div>
                  </div>
                ...
                >
                  <div>
                    ...
                    <div className="text-gray-600">Developed Pranav Iyengar's personal portfolio website displaying his education, achievements and other projects.<strong> Built with HTML, CSS and Javascript</strong></div>
                  </div>
                  <a href="https://www.pranaviyengar.com" target="_blank" className="flex justify-center items-center w-8 h-8 bg-white rounded-full shadow flex-shrink-0 ml-3" id="open-3">
                ...
                >
                  <div>
                    ...
                    <div className="text-gray-600">An informative school website for Seven Senses Montessori<strong> built with HTML, CSS and Javascript</strong></div>
                  </div>
                ...
                >
                  <div>
                    ...
                    <div className="text-gray-600">An E-commerce site for The Rewrap Company<strong> built with Javascript using the Shopify API.</strong></div>
                  </div>
